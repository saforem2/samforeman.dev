...
citation:
   ...
   type: webpage
   title: "How to Make Dope Slides"
   url: https://samforeman.dev/posts/dope-slides
open-graph:
  title: "How to Make Dope Slides"
...
<!-- ::: {.callout-tip icon=false title="[[**LLMs on Polaris**](https://samforeman.dev/talks/llms-on-polaris/#/section) @ [_Center for Scientific Foundation Models_, Summer School 24'](https://scifm.ai/summer_school.html) \[07/2024\]]{.dim-text}" collapse="true" style="width:100%;background-color: rgba(0,0,0,0.0)!important;border:1px solid rgba(131,131,131,0.2)!important;"} -->
...
- Starting with the title slide[^images]:
  ...
  - The full slide contents are included below:
    ...
    [{{< fa solid home >}}](https://samforeman.dev) Sam Foreman  
...
<p align="center">
<a href="https://hits.seeyoufarm.com"><img align="center" src="https://hits.seeyoufarm.com/api/count/incr/badge.svg?url=https%3A%2F%2Fsamforeman.dev%2Fqmd%2Fdope-slides%2F&count_bg=%2300CCFF&title_bg=%23303030&icon=&icon_color=%23E7E7E7&title=hits&edge_flat=false"/></a>
</p>
