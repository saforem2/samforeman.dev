...
# cookie-consent: True
location: "HPC User Forum Fall '24"
location-url: "https://www.hpcuserforum.com/hpc-user-forum-fall-2024/"
...
citation:
   author: Sam Foreman
   type: speech
   url: https://samforeman.dev/talks/hpc-user-forum/slides
# toc-expand: true
format:
  gfm:
...
- 🏡 [samforeman.dev](https://samforeman.dev):
  - 🦜 [Talks](https://samforeman.dev/talks/):
    - [HPC User Forum](https://samforeman.dev/talks/hpc-user-forum/) \[[slides](https://samforeman.dev/talks/hpc-user-forum/slides.html)\]
