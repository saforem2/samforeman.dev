...
location-url: "https://www.alcf.anl.gov/events/2024-alcf-hands-hpc-workshop"
...
citation:
   author: Sam Foreman
   type: speech
   url: https://samforeman.dev/talks/alcf-hpc-workshop-2024/slides
# toc-expand: true
format:
  html:
  ...
  #   slide-url: https://samforeman.dev/talks/hpc-user-forum/slides.html
  revealjs:
    # auto-stretch: true
    callout-style: simple
    # width: 1024
    ...
    pdf-separate-fragments: true
    center: true
    footer: "[samforeman.dev/talks/alcf-hpc-workshop-2024/slides](https://samforeman.dev/talks/alcf-hpc-workshop-2024/slides)"
    slide-url: https://samforeman.dev/talks/alcf-hpc-workshop-2024/slides.html
    shift-heading-level-by: -1
    # template-partials:
    #   - title-slide.html
...
- Slides @ [samforeman.dev/talks/alcf-hpc-workshop-2024/slides](https://samforeman.dev/talks/alcf-hpc-workshop-2024/slides)
  - HTML Version: [samforeman.dev/talks/alcf-hpc-workshop-2024](https://samforeman.dev/talks/alcf-hpc-workshop-2024)
...
![All-Reduce operation: each rank receives the reduction of input values across ranks.](./assets/collective-allreduce-sum.drawio.svg){#fig-all-reduce}
...
![Reduce operation: one rank receives the reduction of input values across ranks](./assets/collective-reduce-sum.drawio.svg){#fig-reduce}

### Broadcast {background-color="white"}

![`broadcast` (_send_) a tensor <code>$x$</code> from one rank to all ranks](./assets/collective-broadcast.drawio.svg){#fig-broadcast}

### AllGather {background-color="white"}

![Gathers tensors from the whole group in a list.](./assets/collective-allgather.drawio.svg){#fig-allgather}
