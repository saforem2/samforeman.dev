...
citation:
   author: Sam Foreman
   type: speech
   url: https://samforeman.dev/talks/AuroraGPT/alcf-hpc-workshop-2024/slides
# toc-expand: true
format:
  # html:
  ...
  revealjs:
    ...
    shift-heading-level-by: -1
    center: false
    footer: "[samforeman.dev/talks/AuroraGPT/alcf-hpc-workshop-2024/slides](https://samforeman.dev/talks/AuroraGPT/alcf-hpc-workshop-2024/slides)"
    slide-url: https://samforeman.dev/talks/AuroraGPT/alcf-hpc-workshop-2024/slides.html
    template-partials:
      - title-slide.html
    ...
    # shift-heading-level-by: -1
  gfm:
    output-file: "AuroraGPT-ALCF-Hands-On-HPC-Workshop-2024.md"
---
...
- [x] Completely re-wrote an asynchronous, distributed implementation that
_significantly_ improves performance (~~60 min~~ $\rightarrow$ 4 min)

::: {.flex-container}

![Time spent building `BlendableDataset`](./assets/blendable.svg){#fig-data-blendable .r-stretch}

![Time spent building `GPTDataset`](./assets/gpt.svg){#fig-data-gpt .r-stretch}
...
::: {.column}
- See my other slides at [samforeman.dev/talks](https://samforeman.dev/talks)
    ...
    - [LLMs on Polaris](https://samforeman.dev/talks/llms-on-polaris/#/title-slide)
    - [Training LLMs at Scale](https://samforeman.dev/talks/llms-at-scale/)
- {{< fa brands github >}} [argonne-lcf / `Megatron-DeepSpeed`](https://github.com/argonne-lcf/Megatron-DeepSpeed)  
...
- Working with
  ...
  team to enable longer sequence lengths (context windows) for LLMs
    - See my [blog post](https://samforeman.dev/posts/auroragpt/long-sequences/) for additional details
