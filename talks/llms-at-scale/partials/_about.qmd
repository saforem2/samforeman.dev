...
<!-- ::: footer -->
<!---->
<!-- [[🏡](https://samforeman.dev) Sam Foreman]{style="color:#555555"}   -->
...
<!---->
<!-- [[{{< iconify ph house-line-duotone >}}](https://samforeman.dev)]{.icon style="font-size:1.5rem; padding-right: 0pt;"} -->
...
<!---->
<!-- [[[samforeman.dev/talks/llms-at-scale]{style="color:#137af5!important; background:oklch(from #137af5 calc(l * 1.15) c h / 0.085); border:0px solid #137af5!important; border-radius: 0.25rem; text-shadow: 1px 1px rgba(0, 0, 0, 0.25);"}](https://samforeman.dev/talks/llms-at-scale)]{style="text-align:center;"}   -->
<!---->
<!-- ::: -->
<!---->
<!-- ::: -->
