...
citation:
   author: Sam Foreman
   type: speech
   url: https://samforeman.dev/talks/llms-at-scale
format:
  html:
    ...
    #   body-width: 800px
  revealjs:
    slides-url: https://samforeman.dev/talks/llms-at-scale/slides.html
    template-partials:
      - ./title-slide.html
...
- 🏡 [samforeman.dev](https://samforeman.dev):
  ...
  - 🦜 [Talks](https://samforeman.dev/talks/):
    - [Training LLMs at Scale](https://samforeman.dev/talks/llms-at-scale/) \[[slides](https://samforeman.dev/talks/llms-at-scale/slides.html)\]
  ...
  - 📦 [Repos](https://github.com/saforem2/):
    ...
    <!-- - \[[slides](https://samforeman.dev/talks/llms-at-scale/slides.html)\] -->
