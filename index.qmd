...
author: "Sam Foreman"
site-url: "https://samforeman.dev"
repo-actions: false
appendix-site-as: false
body-footer: |
    <img src='https://hits.seeyoufarm.com/api/count/incr/badge.svg?url=https%3A%2F%2Fsamforeman.dev&count_bg=%23838383&title_bg=%23303030&icon=&icon_color=%23E7E7E7&title=hits&edge_flat=false'>
code-tools: false
citation: false
toc: false
...
[[{{< iconify ph house inline=true >}}]{.icon .dim-text style="font-size: 1.5rem; padding-right:0pt;"}](https://samforeman.dev)
...
<!-- ::: {.callout-tip icon=false aria-title="✏️ Status" title='[✏️ Status]{.dim-text}' collapse="true" style="text-align: left!important; width:100%; background-color:rgba(131,131,131,0.05)!important; border: 1px solid rgba(131,131,131,0.0); opacity:100%;"} -->
::: {.callout-tip icon=false aria-title="✏️ Status" title='[👀 More]{.dim-text}' collapse="true" style="text-align: left!important; width:100%; background-color:rgba(131,131,131,0.05)!important; border: 1px solid rgba(131,131,131,0.0); opacity:100%;"}
...
[© Copyright [Sam Foreman](https://samforeman.dev)]{.dim-text}
...
- HTML: <https://samforeman.dev/talks/ai-for-science-2024/>
- Slides: <https://samforeman.dev/talks/ai-for-science-2024/slides>
:::
